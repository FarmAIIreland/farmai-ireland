...
sources:
  - label: "Teagasc Digital Farming"
    ...
    description: "Irish context for digital agriculture and AI adoption"
---
...
A text-based AI tool you can use for free at [chat.openai.com](https://chat.openai.com). You type a question or task in plain English and it responds. That's it. No technical knowledge needed.
...
For the full glossary with every term defined, see the [Plain English AI Glossary for Irish Farmers](/guides/ai-glossary).

**Read next:** [Your first 10 ChatGPT prompts as an Irish farmer](/guides/chatgpt-first-10-prompts-farmers)
