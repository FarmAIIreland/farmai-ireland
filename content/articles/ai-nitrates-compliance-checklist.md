...
sources:
  - label: "Nitrates Action Programme — Department of Agriculture"
    url: "https://www.gov.ie/en/publication/nitrates/"
    description: "Official nitrates regulations, closed periods, and storage requirements"
  - label: "Teagasc — Nutrient Management"
    url: "https://www.teagasc.ie/environment/nutrient-management/"
    description: "Teagasc guidance on nutrient management planning and nitrates compliance"
  - label: "Environmental Protection Agency — Water Quality"
    url: "https://www.epa.ie/our-services/monitoring--assessment/assessment/water-quality/"
    description: "EPA water quality monitoring and nitrates reporting data"
...
**AI doesn't know the current closed period dates with certainty.** These are set by Statutory Instrument and can change. Always verify against the [current DAFM nitrates regulations](https://www.gov.ie/en/publication/nitrates/).
...
Verify everything against [gov.ie](https://www.gov.ie/en/publication/nitrates/) and talk to your Teagasc advisor if you're unsure about your storage or stocking rate. The five minutes you spend building a checklist now could save you a lot more than five minutes if the inspector calls.
