...
sources:
  - label: "Teagasc — e-Profit Monitor"
    url: "https://www.teagasc.ie/rural-economy/farm-management/financial-analysis/e-profit-monitor/"
    description: "Teagasc's farm financial benchmarking tool for comparing performance"
  - label: "ICMSA — Farm Input Costs"
    url: "https://www.icmsa.ie/"
    description: "ICMSA analysis of farm input costs and margins across Irish farming sectors"
  - label: "Teagasc — Situation and Outlook"
    url: "https://www.teagasc.ie/rural-economy/rural-economy/outlook/"
    description: "Teagasc annual outlook report on farm incomes and cost projections"
readNext: "ai-farm-business-plan-bank"
---

# AI for farm cashflow: how to build a 12-month forecast without a spreadsheet

Profit and cashflow are different things. You can have a profitable year and still run out of money in March. Every farmer knows this — the bills don't arrive when the payments do.
...
- **Teagasc e-Profit Monitor** — if you're enrolled, your advisor can show you how your costs compare to similar farms. Use this to sanity-check your expense estimates.
