...
seo:
  ...
  keywords: ["ICBF herd register Ireland", "cattle movement notifications Ireland", "DAFM cattle tagging", "suckler farm paperwork AI", "ChatGPT herd register", "ICBF submission help"]
youtubeEmbed: ""
featured: false
...
1. Open ChatGPT (free account at chat.openai.com)
2. Create a new chat and type: *"I'm an Irish suckler farmer and I want to use you to help format herd register entries for ICBF submissions. I'll give you calving notes and you format them as complete register entries, flagging anything missing."*
3. Paste in last week's calving notes as a test
4. Review the output — does it flag the missing fields correctly?
5. Save the prompt as a custom instruction in ChatGPT (Settings → Custom Instructions) so it's ready every time
