---
title: "PastureBase and your phone: measure grass without walking every field"
...
seo:
  ...
  description: "How Irish dairy and beef farmers are using PastureBase and satellite grass tools to cut the time spent on grass measurement. Plain English setup guide."
  keywords: ["PastureBase Ireland guide", "grass measurement app Ireland", "spring grass dairy farming", "Teagasc grass app"]
sponsorship:
  enabled: false
  sponsor: ""
  label: ""
  logo: ""
sources:
  - label: "PastureBase Ireland"
    url: "https://www.pasturebase.ie"
    description: "National grass measurement platform data and methodology"
  - label: "Teagasc Grass10 Programme"
    url: "https://www.teagasc.ie/crops/grassland/grass10/"
    description: "Grass measurement targets and benchmarking data"
  - label: "Bord Bia Pasture Profit Index"
    url: "https://www.bordbia.ie"
    description: "Context for grass utilisation benchmarks"
---
...
**Step one:** Register at [pasturebase.ie](https://www.pasturebase.ie). You'll need your herd number. Takes five minutes. If you've already registered but forgotten your login, the password reset works fine — just use the email you signed up with.
...
If you're new to grass measurement, the [Teagasc Grass10 resources](https://www.teagasc.ie/crops/grassland/grass10/) are worth reading alongside setting this up. The tool only works as well as your understanding of what the numbers mean.

---

> **A note on grass management decisions:** PastureBase is a data tool, not an advisory service. For grazing management advice specific to your farm system, talk to your Teagasc advisor.
> [Find your local office →](https://www.teagasc.ie/contact/)

---

**Read next:** [Save 3 hours at calving with these two free apps](/guides/save-time-calving-apps)
