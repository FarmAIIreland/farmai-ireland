...
The [10 prompts guide](/guides/chatgpt-first-10-prompts-farmers) is the fastest on-ramp — ten things you can type into ChatGPT today that return something immediately useful. No setup, no payment, five minutes.

If you want to understand what AI actually is before using it, the [glossary](/guides/ai-glossary) covers the terms in plain English without making it more complicated than it needs to be.
...
We have a [guide that walks through exactly what to use ChatGPT for in a BISS application](/guides/chatgpt-biss-application-guide), and what to do yourself or with your advisor.
...
**Read next:** [The Plain English AI Glossary for Irish Farmers](/guides/ai-glossary)
