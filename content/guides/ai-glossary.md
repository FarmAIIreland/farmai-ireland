...
A text-based AI tool made by a US company called OpenAI. You type a question or task in plain English and it responds. The free version is genuinely useful for drafting, explaining, and organising. You don't need an account to try it — go to [chat.openai.com](https://chat.openai.com).
